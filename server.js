...
//HIGHLY Speculative feature: get Cryptocurrency pricing data
// app.get('/cryptoData', function(req, res) {
//   app.get('https://api.coinmarketcap.com/v1/ticker/', function(req, res) {
//     if (req) {
//       console.log('error GET line 67 server', req)
//     } else if(res) {
//       console.log('SUCCESS GET line 69 server', res);//response is data sent back from server(aka all db entries)
//     }
//   });
// });
